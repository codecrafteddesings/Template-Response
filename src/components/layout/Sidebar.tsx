...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed z-50 top-0 left-0 h-full w-64 bg-white shadow-md dark:bg-black dark:border-r dark:border-slate-700
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive
                    ...
                    : "text-gray-600 hover:bg-gray-100 hover:text-gray-800 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
                }`
              }
            >
              {item.icon}
